...
SIZE = WIDTH, HEIGHT = 800, 500  # Вот эту строку лучше не импортировать через from, т.к. она в начале игры изменится,
...
def is_collide_with_speed(player, image, x, y, x_speed, y_speed):
    if any([x_speed, y_speed]):
        ...
        player.rect.y += player.rect.height // 1.5  # Мы смотрим коллизию по ногам, а не по телу
        player.rect.height -= player.rect.height // 1.5
